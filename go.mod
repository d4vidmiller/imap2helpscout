module imap2helpscout

go 1.18

require (
	github.com/BrianLeishman/go-imap v0.0.0-20220307142709-356e9ab3bc77
	github.com/StirlingMarketingGroup/go-helpscout v0.0.0-20210714172539-b0567ef7a86a
